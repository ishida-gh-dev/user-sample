declare global {
  ...
  const dbAlter: typeof import('../../server/utils/db.alter').default
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/home/ishida/workspaces/work_nuxt/test/user-sample/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/home/ishida/workspaces/work_nuxt/test/user-sample/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { default as dbAlter } from '/home/ishida/workspaces/work_nuxt/test/user-sample/server/utils/db.alter';
export { default as db } from '/home/ishida/workspaces/work_nuxt/test/user-sample/server/utils/db';